...
Map.protoype.drawImage = function (imgId, x, y) { //Draws Image
	this.img = document.getElementById(imgId)
	this.context.drawImage(img, x, y, tileSize, tileSize)
}

Map.protoype.drawTiles = function () { //Draws Tiles
...
Map.protoype.drawTile = function (tileId, tileX, tileY) { //Draws image using tile coords
	this.drawImage(tileId, tileX * this.tileSize, tileY * this.tileSize)
}

Map.protoype.clear = function () { //Clears canvas
